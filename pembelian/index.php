...
if (isset($_POST['simpan'])) {
    if (simpan($_POST)) {
        echo "<script>
        alert('data pembelian berhasil di simpan..');
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline card-danger pt-3 px-3 pb-2">
                            ...
                            <?= number_format(totalBeli($noBeli),0,',','.') ?></h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="nmBrg"  class="form-control form-control-sm" id="nmBrg" 
                                    ...
                                    foreach ($brgDetail as $detail) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                &idbeli=<?= $detail['no_beli']  ?>&qty=<?= $detail['qty']  ?>&tgl=<?= $detail['tgl_beli']  ?>
