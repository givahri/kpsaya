...
if ($msg == 'updated') {
    ...
    $alert = "<script>
            $(document).ready(function(){
                $(document).Toasts('create', {
                    title       : '$user',
                    body        : 'Data barang berhasil di perbarui..',
                    class       : 'bg-success',
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                title="cetak Barcode"><i class="fas fa-barcode"></i></button>
                                ...
                                class="btn btn-danger btn-sm" title="hapus barang" onclick="
                                return confirm('anda yakin akan menghapus barang ini ?')" ><i class="fas fa-trash"></i> </a>
                            </td>
                        </tr>
                        <?php
                        }
