      ...
      <div class="container-fluid">
        ...
        <div class="card-header">
                <h3 class="card-title"><i class="fas fa-list fa-sm"></i> Data Pembelian </h3>
                    ...
                    data-toggle="modal" data-target="#mdlPeriodeBeli"><i class="fas fa-print"> Cetak</i></button>
                </div>
                      ...
                      <?php
                        ...
                        foreach($pembelian as $beli) { ?>
                            ...
                            <tr>
                              ...
                              <td class="text-center"><a href="detail-pembelian.php?id=<?= $beli['no_beli'] ?>
                              &tgl=<?= in_date($beli['tgl_beli'] ) ?>" class="brn btn-sm btn-info" title="rincian barang">Detail</a> </td>
                            </tr>
