                    ...
                    <input type="hidden" name="id" value="<?= $supplier['id_supplier'] ?>">
                        ...
                        <div class="col-lg-8 mb-3">
                            <div class="form-group">
                                ...
                                autofocus  value="<?= $supplier['nama'] ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="telepon">Telepon</label>
                                <input type="text" name="telepon" class="form-control" id="telepon" 
                                placeholder="nomor telepon supplier" pettern="[0-9]{5,}" title="minimal 5 angka" value="<?= $supplier['telepon'] ?>"
                                required>
                            </div>

                            <div class="form-group">
                                <label for="keterangan">Deskripsi</label>
                                <textarea name="keterangan" id="keterangan" rows="1" class="form-control" placeholder="keterangan supplier" 
