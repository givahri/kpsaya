...
$title = " Transaksi - POS Nans Beauty";
        ...
        <div class="container-fluid">
            <form action="" method="post">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-10 input-group">
                                ...
                                value="<?= @$_GET['barcode'] ? $_GET['barcode'] : '' ?>" class="form-control" placeholder="masukan barcode barang">
                ...
                <div class="card pt-1 pb-2 px-3">
                    ...
                    <button type="submit" class="btn btn-sm btn-info btn-block" name="addbrg" ><i class="fas fa-plus fa-sm"></i> Tambah Barang </button>
                </div>
                            ...
                            foreach ($brgDetail as $detail) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="?barcode=<?= $detail['barcode']  ?>
                                        &idjual=<?= $detail['no_jual']  ?>&qty=<?= $detail['qty']  ?>&tgl=<?= $detail['tgl_jual']  ?>
                                        &msg=deleted" class="btn btn-sm btn-danger" title="hapus barang" 
                                        onclick="return confirm('Anda yakin akan menghapus barang ini ??') "><i class="fas fa-trash"></i></a>
                                    </td>
                        ...
                        <div class="col-sm-9">
                            <select name="customer" id="customer" class="form-control form-control-sm">
                                ...
                                <?php
                                        ...
                                        $curtomers = getData("SELECT * FROM tbl_customer ");
