...
function insert($data)
{
    ...
    if ($password !== $password2) {
        ...
        alert('Konfirmasi password tidak sesuai, User gagal diregistrasi ! ');
...
function update($data)
{
   ...
   if ($username !== $curUsername) {
    if (mysqli_num_rows($newUsername)) {
            ...
            alert('Username sudah terpakai, update data user gagal diregistrasi ! ');
