      ...
      <div class="container-fluid">
        ...
        <div class="card-header">
                <h3 class="card-title"><i class="fas fa-list fa-sm"></i> Data Penjualan </h3>
                    ...
                    data-toggle="modal" data-target="#mdlPeriodeJual"><i class="fas fa-print"> Cetak</i></button>
                </div>
                      ...
                      <?php
                        ...
                        foreach($penjualan as $jual) { ?>
                            ...
                            <tr>
                              ...
                              <td class="text-center"><a href="detail-penjualan.php?id=<?= $jual['no_jual'] ?>
                              &tgl=<?= in_date($jual['tgl_jual'] ) ?>" class="brn btn-sm btn-info" title="rincian barang">Detail</a> </td>
                            </tr>
