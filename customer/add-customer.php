...
$title = "Tambah Customer - Toko Saya";
                    ...
                    <div class="row">
                        ...
                        echo $alert;
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Nomor telepon customer" pettern="[0-9]{5,}" title="minimal 5 angka"
                                required>
                            </div>

                            <div class="form-group">
                                <label for="keterangan">Deskripsi</label>
                                <textarea name="keterangan" id="keterangan" rows="1" class="form-control" placeholder="Keterangan customer" required></textarea>
                            </div>
