                    ...
                    <input type="hidden" name="id" value="<?= $customer['id_customer'] ?>">
                        ...
                        <div class="col-lg-8 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" id="nama" placeholder="nama customer" 
                                autofocus  value="<?= $customer['nama'] ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="telepon">Telepon</label>
                                <input type="text" name="telepon" class="form-control" id="telepon" 
                                placeholder="nomor telepon customer" pettern="[0-9]{5,}" title="minimal 5 angka" value="<?= $customer['telepon'] ?>"
                                required>
                            </div>

                            <div class="form-group">
                                <label for="keterangan">Deskripsi</label>
                                <textarea name="keterangan" id="keterangan" rows="1" class="form-control" placeholder="keterangan customer" 
