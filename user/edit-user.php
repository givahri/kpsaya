                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" class="form-control" id="fullname" placeholder="masukan nama lengkap" value="<?=  $user['fullname'] ?>"
                                required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                placeholder="masukan alamat user" required><?=  $user['address'] ?></textarea>
