                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="del-user.php?id=<?= $user['userid'] ?>&foto=<?= $user['foto'] ?>" class="btn btn-sm btn-danger" 
                                        title="delete user" onclick="return confirm  ('anda yakin akan menghapus user ini ??')"><i class="fas fa-user-times"></i></a>
