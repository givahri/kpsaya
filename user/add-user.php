                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" class="form-control" id="fulname" placeholder="masukan nama lengkap" 
                                required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password2" class="form-control" id="password2" placeholder="masukan kembali password anda" 
                                 required>
                            </div>
                            ...
                            <div class="col-lg-4 text-center">
                                <img src="<?= $main_url ?>asset/image/gambar1.png" class="profile-user-img img-circle mb-3" alt="">
